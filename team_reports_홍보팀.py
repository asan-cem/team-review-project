...
OUTPUT_HTML_FILE = "서울아산병원 협업평가 대시보드_홍보팀.html"  # 출력 HTML 파일
...
# 📊 대시보드 정보
DASHBOARD_TITLE = "서울아산병원 협업 평가 대시보드 - 홍보팀"
...
<body>
    ...
    <script>
        ...
        function populateFilters() {{
            ...
            deptSelect.innerHTML = `<option value="홍보팀">홍보팀</option>`;
            deptSelect.value = "홍보팀";
        ...
        function updateNetworkDepartments() {{
            ...
            // 부서 드롭다운을 홍보팀으로 고정
            departmentSelect.innerHTML = `<option value="홍보팀">홍보팀</option>`;
            departmentSelect.value = "홍보팀";
