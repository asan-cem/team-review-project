...
<body>
    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <div class="filters">
                <div class="filter-group">
                    <label for="division-chart-filter">부문</label>
                    <div id="division-display" style="padding: 8px; border-radius: 5px; border: 1px solid #ced4da; min-width: 200px; background-color: #e9ecef;">커뮤니케이션실</div>
                </div>
                <div class="filter-group">
                    <label>문항 선택</label>
                    <div class="expander-container">
