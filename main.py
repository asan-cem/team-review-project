...
def main():
    ...
    CSV_FILE = "설문조사_전처리데이터_20250620_0731.xlsx"
    COLUMN_NAME = "협업 후기"
    ...
    try:
        ...
        # CSV 파일의 협업 후기 컬럼 처리 (상단 30개 데이터)
        analyzer.process_csv_with_column(CSV_FILE, COLUMN_NAME, OUTPUT_FILE, delay=0.05, max_rows=MAX_ROWS)
